package io.nortonahu.customhorizonviewpage;
...
//        DeviceInfoUtils.getScreenSize(this);
    ...
    @OnClick({R.id.toolBar_act,R.id.recylerview_act})
    public void goToolbarActivity(Button button ) {
        Intent intent;
        switch (button.getId()){
            case R.id.toolBar_act:
